...
SFSE-MCP must also be pinned and expanded in binary-release source archives.
Because GitHub's automatic source archives do not expand submodules, each binary
release also includes `BoostpacksUseO2-v0.5.0-source.zip`. That asset contains
